...
export class AudioRecorder {
    ...
    async createAudioProcessor() {
        ...
        try {
            if (this.audioContext.audioWorklet) {
                ...
                log('AudioWorklet unavailable, falling back to ScriptProcessorNode', 'warning');
                return this.createScriptProcessor();
            }
        } catch (error) {
            log(`Audio processor creation failed: ${error.message}, trying fallback`, 'error');
            return this.createScriptProcessor();
        }
    }
    ...
    createScriptProcessor() {
        try {
            ...
            silent.connect(this.audioContext.destination);
            log('ScriptProcessorNode fallback succeeded', 'warning');
    ...
    async start() {
        ...
        try {
            ...
            log('Please record at least 1-2 seconds to ensure sufficient data', 'info');
