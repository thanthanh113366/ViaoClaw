        ...
        if "function_call" in intent_data:
            ...
            if function_name == "result_for_context":
                ...
                def process_context_result():
                    ...
                    # Build context prompt (English instructions; reply must be Vietnamese)
                    context_prompt = f"""Context:
                        - Current time: {current_time}
                        - Today's date: {today_date} ({today_weekday})
                        - Today's lunar calendar: {lunar_date}

                        Using the context above, answer the user's question: {original_text}

                        You must respond in Vietnamese only. Be concise and speak naturally."""
